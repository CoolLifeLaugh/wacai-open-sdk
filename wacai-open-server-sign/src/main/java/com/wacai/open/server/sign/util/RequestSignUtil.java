package com.wacai.open.server.sign.util;

import static com.wacai.open.common.util.SignUtil.generateSign;
...
public class RequestSignUtil {
	...
	private static final String X_WAC_SIGNATURE = "x-wac-signature";

	private static final String X_WAC_SIGNATURE_HEADERS = "x-wac-signature-headers";
