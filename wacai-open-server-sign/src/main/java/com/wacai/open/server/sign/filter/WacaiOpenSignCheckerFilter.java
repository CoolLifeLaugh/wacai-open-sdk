package com.wacai.open.server.sign.filter;

import com.wacai.open.server.sign.request.WacaiHttpServletRequest;
import com.wacai.open.server.sign.util.RequestSignUtil;
...
public class WacaiOpenSignCheckerFilter implements Filter {
	...
	private static final byte[] errorBytes = "{\"code\":10008, \"error\":\"sign值不匹配\"}"
