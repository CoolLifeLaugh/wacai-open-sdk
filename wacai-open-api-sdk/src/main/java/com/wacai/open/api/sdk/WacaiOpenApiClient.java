...
import static com.wacai.open.api.sdk.error.ApiGwErrorCode.ERROR_RET_TYPE;
import static com.wacai.open.common.error.CommonErrorCode.CLIENT_SYSTEM_ERROR;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_ACCESS_TOKEN;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_APP_KEY;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_DECODE;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_SDK_VERSION;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_SIGNATURE;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_TIMESTAMP;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_TRACE_ID;
import static com.wacai.open.api.sdk.request.WacaiOpenApiHeader.X_WAC_VERSION;

import com.wacai.open.common.ex.WacaiOpenApiResponseException;
import com.wacai.open.common.json.JsonProcessor;
import com.wacai.open.common.json.JsonTool;
import com.wacai.open.common.json.TypeReference;
import com.wacai.open.common.response.WacaiErrorResponse;
import com.wacai.open.common.util.SignUtil;
import com.wacai.open.api.sdk.request.WacaiOpenApiRequest;
import com.wacai.open.api.sdk.response.WacaiOpenApiResponseCallback;
	...
	private <T> T doInvoke(WacaiOpenApiRequest wacaiOpenApiRequest, Type type) {
		...
		try (Response response = client.newCall(request).execute()) {
			...
			if (body == null) {
				...
				throw new WacaiOpenApiResponseException(CLIENT_SYSTEM_ERROR);
			}
			...
			throw new WacaiOpenApiResponseException(CLIENT_SYSTEM_ERROR, e);
		} catch (ClassCastException e) {
			throw new WacaiOpenApiResponseException(ERROR_RET_TYPE, e);
		}
	}
	...
	private <T> void doInvoke(final WacaiOpenApiRequest wacaiOpenApiRequest,
		...
		client.newCall(request).enqueue(new Callback() {
			...
			public void onFailure(Call call, IOException e) {
				callback.onFailure(new WacaiOpenApiResponseException(CLIENT_SYSTEM_ERROR, e));
			}
			...
			public void onResponse(Call call, Response response) throws IOException {
				ResponseBody body = response.body();
				if (body == null) {
					callback.onFailure(new WacaiOpenApiResponseException(CLIENT_SYSTEM_ERROR));
					return;
				}
				...
				if (response.code() == 200) {
					...
					try {
						...
						callback.onFailure(new WacaiOpenApiResponseException(ERROR_RET_TYPE));
					}
					return;
				} else if (response.code() == 400) {
					WacaiErrorResponse wacaiErrorResponse;
